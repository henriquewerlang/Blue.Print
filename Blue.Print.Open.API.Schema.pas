unit Blue.Print.Open.API.Schema;
...
uses System.Generics.Collections, Blue.Print.Types;
...
type
  ...
  private
    ...
    FtokenUrl: String;
    FrefreshUrl: String;
    Fscopes: TArray<TPair<String, String>>;
  published
    ...
    property scopes: TArray<TPair<String, String>> read Fscopes write Fscopes;
  end;
  ...
  private
    FRequiriments: TArray<TPair<String, String>>;
  published
    property Requiriments: TArray<TPair<String, String>> read FRequiriments write FRequiriments;
  end;

  TDiscriminatorObject = class
  private
    FpropertyName: String;
    Fmapping: TArray<TPair<String, String>>;
  published
    property propertyName: String read FpropertyName write FpropertyName;
    property mapping: TArray<TPair<String, String>> read Fmapping write Fmapping;
  end;
  ...
  private
    Furl: String;
    Fdescription: String;
    Fvariables: TArray<TPair<String, TServerVariableObject>>;
  published
    property url: String read Furl write Furl;
    property description: String read Fdescription write Fdescription;
    property variables: TArray<TPair<String, TServerVariableObject>> read Fvariables write Fvariables;
  end;
  ...
  private
    FcontentType: String;
    Fheaders: TArray<TPair<String, THeaderObject>>;
    Fstyle: TStyle;
    Fexplode: Boolean;
    FallowReserved: Boolean;
  published
    property contentType: String read FcontentType write FcontentType;
    property headers: TArray<TPair<String, THeaderObject>> read Fheaders write Fheaders;
  ...
  private
    ...
    Fexamples: TArray<TPair<String, TExampleObject>>;
    Fexample: String;
    Fencoding: TArray<TPair<String, TEncodingObject>>;
  published
    property schema: TSchemaObject read Fschema write Fschema;
    property example: String read Fexample write Fexample;
    property examples: TArray<TPair<String, TExampleObject>> read Fexamples write Fexamples;
    property encoding: TArray<TPair<String, TEncodingObject>> read Fencoding write Fencoding;
  end;
  ...
  private
    ...
    Fproperties: TArray<TSchemaObject>;
  ...
  published
    ...
    property properties: TArray<TSchemaObject> read Fproperties write Fproperties;
  ...
  private
    ...
    FoperationId: String;
    Fparameters: TArray<TPair<String, String>>;
    FrequestBody: String;
    Fdescription: String;
  ...
  published
    ...
    property parameters: TArray<TPair<String, String>> read Fparameters write Fparameters;
  ...
  private
    Fdescription: String;
    Fheaders: TArray<TPair<String, THeaderObject>>;
    Fcontent: TArray<TPair<String, TMediaTypeObject>>;
    Flinks: TArray<TPair<String, TLinkObject>>;
  published
    property description: String read Fdescription write Fdescription;
    property headers: TArray<TPair<String, THeaderObject>> read Fheaders write Fheaders;
    property content: TArray<TPair<String, TMediaTypeObject>> read Fcontent write Fcontent;
    property links: TArray<TPair<String, TLinkObject>> read Flinks write Flinks;
  end;
  ...
  private
    FExpressions: TArray<TPair<String, TPathItemObject>>;
  published
    [Default]
    property Expressions: TArray<TPair<String, TPathItemObject>> read FExpressions write FExpressions;
  end;

  TResponsesObject = class
  private
    Fdefault: TResponseObject;
    FHTTPStatusCode: TArray<TPair<Integer, TResponseObject>>;
  published
    property &default: TResponseObject read Fdefault write Fdefault;
    [Default]
    property HTTPStatusCode: TArray<TPair<Integer, TResponseObject>> read FHTTPStatusCode write FHTTPStatusCode;
  end;
  ...
  private
    ...
    Fcallbacks: TArray<TPair<String, TCallbackObject>>;
    Fdeprecated: Boolean;
  ...
  published
    ...
    property callbacks: TArray<TPair<String, TCallbackObject>> read Fcallbacks write Fcallbacks;
    property deprecated: Boolean read Fdeprecated write Fdeprecated;
  ...
  TPathsObject = class
  private
    FPaths: TArray<TPair<String, TPathItemObject>>;
  published
    [Default]
    property Paths: TArray<TPair<String, TPathItemObject>> read FPaths write FPaths;
  end;

  TComponentsObject = class
  private
    Fschemas: TArray<TPair<String, TSchemaObject>>;
    Fresponses: TArray<TPair<String, TResponseObject>>;
    Fparameters: TArray<TPair<String, TParameterObject>>;
    Fexamples: TArray<TPair<String, TExampleObject>>;
    FrequestBodies: TArray<TPair<String, TRequestBodyObject>>;
    Fheaders: TArray<TPair<String, THeaderObject>>;
    FsecuritySchemes: TArray<TPair<String, TSecuritySchemeObject>>;
    Flinks: TArray<TPair<String, TLinkObject>>;
    Fcallbacks: TArray<TPair<String, TCallbackObject>>;
  published
    property schemas: TArray<TPair<String, TSchemaObject>> read Fschemas write Fschemas;
    property responses: TArray<TPair<String, TResponseObject>> read Fresponses write Fresponses;
    property parameters: TArray<TPair<String, TParameterObject>> read Fparameters write Fparameters;
    property examples: TArray<TPair<String, TExampleObject>> read Fexamples write Fexamples;
    property requestBodies: TArray<TPair<String, TRequestBodyObject>> read FrequestBodies write FrequestBodies;
    property headers: TArray<TPair<String, THeaderObject>> read Fheaders write Fheaders;
    property securitySchemes: TArray<TPair<String, TSecuritySchemeObject>> read FsecuritySchemes write FsecuritySchemes;
    property links: TArray<TPair<String, TLinkObject>> read Flinks write Flinks;
    property callbacks: TArray<TPair<String, TCallbackObject>> read Fcallbacks write Fcallbacks;
  end;
