...
begin
  if not Assigned(FAnonymous2) then
    FAnonymous2 := TDynamicProperty<Blue.Print.JSON.Schema.TSchema.TObject.TDependencies.TAnonymous2>.Create;

  Result := FAnonymous2;
end;

function TSchema.TObject.TDependencies.GetAnonymous2Stored: Boolean;
begin
